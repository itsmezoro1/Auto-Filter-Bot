class script(object):
    ...
    𝐈 𝐂𝐚𝐧 𝐏𝐫𝐨𝐯𝐢𝐝𝐞 𝐘𝐨𝐮 𝐌𝐨𝐯𝐢𝐞𝐬 𝐀𝐧𝐝 𝐒𝐞𝐫𝐢𝐞𝐬❤️ 𝐃𝐨𝐧'𝐭 𝐒𝐞𝐚𝐫𝐜𝐡 𝐅𝐨𝐫 𝐓𝐡𝐞𝐚𝐭𝐫𝐞 𝐏𝐫𝐢𝐧𝐭𝐬 𝐀𝐧𝐝 𝐌𝐨𝐯𝐢𝐞𝐬 𝐖𝐡𝐢𝐜𝐡 𝐀𝐫𝐞 𝐍𝐨𝐭 𝐘𝐞𝐭 𝐑𝐞𝐚𝐥𝐞𝐚𝐬𝐞𝐝 𝐈𝐧 𝐎𝐓𝐓𝐒 😑 Jᴜsᴛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ As Aᴅᴍɪɴ Aɴᴅ Eɴᴊᴏʏ 😍  </b>"""
